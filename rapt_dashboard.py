    ...
    if (type === 'direct') {
        ...
        function tickGradual() {
            ...
            if (complete) {
                ...
                timerEl.innerHTML = `🎯 Current target: <span class="font-bold text-blue-300">${currentTarget.toFixed(1)}°C</span>
                    &nbsp;|&nbsp; Next 3°C drop in: <span class="font-bold text-blue-300">${nextHours}h ${nextMins}m</span>
                    &nbsp;|&nbsp; Dropping to: <span class="font-bold text-blue-300">${Math.max(targetTemp, currentTarget - 3).toFixed(1)}°C</span>`
            }
        }
