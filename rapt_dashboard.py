# ============================================================
# VIEW LOG (FULL ORIGINAL LAYOUT RESTORED + corrected temperature)
# ============================================================
@app.route("/view_log")
def view_log():
    ...
    with open(csv_file, "r") as f:
        ...
        for row in reader:
            try:
                # Support both old "temperature" column and new "temperature_raw"
                ...
                data.append({
                    ...
                    "temperature": corrected_temp,   # used in chart
    ...
    temps = [d["temperature"] for d in data]   # corrected values for chart
