...
# ============================================================
#  VIEW LOG (MODERN UI WITH FILTERING)
# ============================================================
@app.route("/view_log")
def view_log():
    csv_file = get_current_brew_log_csv_filename()
...
<div class="container">
    ...
    <div class="card">
        ...
        <div class="range-row">
            <div>
                <label for="startRange">Start</label><br>
                <input type="datetime-local" id="startRange">
            </div>
            <div>
                <label for="endRange">End</label><br>
    ...
    <div class="card" style="margin-top: 18px;">
        <div class="card-header">
            <div class="card-title">Gravity & Temperature</div>
        </div>
    ...
    <div class="card" style="margin-top: 18px;">
        <div class="json-title">JSON Output (filtered)</div>
...
<script>
    ...
    function applyCustomRange() {{
        const startInput = document.getElementById("startRange").value;
        const endInput = document.getElementById("endRange").value;
    ...
    function render(data) {{
        ...
        chart.data.datasets[0].data = gravities;
