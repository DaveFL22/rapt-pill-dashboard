...
<body class="bg-zinc-950 text-white min-h-screen p-6">
    ...
    <!-- DRY HOP GROUP -->
    <div id="dryHopGroup" class="hidden max-w-5xl mx-auto mb-4 rounded-3xl border border-green-700 overflow-hidden">
        <div id="dryHopHeader" class="p-5 bg-zinc-900 text-lg font-medium text-zinc-400">
            🌿 Dry Hop Additions
        </div>
        <div id="dryHopRows"></div>
    </div>
    ...
    <!-- COLD CRASH GROUP -->
    <div id="coldCrashGroup" class="hidden max-w-5xl mx-auto mb-4 rounded-3xl border border-blue-700 overflow-hidden">
        <div id="coldCrashStatus" class="p-5 bg-zinc-900 text-lg font-medium text-zinc-400">
            🧊 Cold Crash: --
        </div>
