...
<body class="bg-zinc-950 text-white min-h-screen p-6">
    ...
    <!-- HEADER ROW: title left, Start New Brew right -->
    ...
    <!-- SECOND ROW: centered 3-button row -->
    <div class="max-w-5xl mx-auto mt-6 mb-6">
        <div class="w-full flex justify-center">
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-3">

                <a href="/view_log" target="_blank" rel="noopener"
                   class="flex items-center justify-center gap-2 bg-zinc-800 hover:bg-zinc-700 text-blue-400 text-sm px-4 py-3 rounded-2xl">
                    📄 <span>View Log</span>
                </a>

                <button onclick="pullFromGitHub()"
                    class="flex items-center justify-center bg-zinc-800 hover:bg-zinc-700 text-amber-300 text-sm px-4 py-3 rounded-2xl">
                    ⬇ Pull Log from GitHub
                </button>

                <button onclick="pushToGitHub()"
                    class="flex items-center justify-center bg-zinc-800 hover:bg-zinc-700 text-emerald-400 text-sm px-4 py-3 rounded-2xl">
...
# ============================================================
#  BLOCK 5B — LOG VIEWER HTML + JAVASCRIPT (FULLY MERGED)
# ============================================================
...
<body class="bg-zinc-950 text-white p-6">
    ...
    <div class="max-w-5xl mx-auto mb-6">
        ...
        <h1 class="text-3xl font-semibold mb-2">Fermentation Log Viewer</h1>

        <!-- Close Page Button -->
        <button onclick="window.close()"
                class="bg-zinc-800 hover:bg-zinc-700 text-red-400 px-4 py-2 rounded-lg mb-4">
            ✖ Close Page
        </button>

        <p class="text-zinc-400 mb-4">View and explore your fermentation history.</p>
        ...
        <!-- Date range -->
        <div class="flex gap-3 mb-6">
            <input type="date" id="startDate" class="bg-zinc-800 text-white px-3 py-2 rounded-lg">
            <input type="date" id="endDate" class="bg-zinc-800 text-white px-3 py-2 rounded-lg">
...
function setActiveButton(activeId) {
    const buttons = ["btn24", "btn48", "btnAll"];
    buttons.forEach(id => {
