        ...
        <div class="bg-zinc-900 p-8 rounded-3xl w-full max-w-lg max-h-[90vh] overflow-y-auto my-4">
            ...
            <form id="brewForm">
                ...
                <div class="mb-6 pl-4 border-l-2 border-blue-500 space-y-3">
                    <p class="text-zinc-300 font-medium">🧊 Cold Crash</p>
                    <label class="flex items-center gap-3 cursor-pointer">
                        <input type="checkbox" name="cold_crash_type" id="coldCrashDirect" value="direct"
                            class="w-5 h-5 rounded accent-blue-400"
                            onchange="toggleColdCrash('direct', this.checked)" />
                        <span class="text-zinc-300 text-sm">Direct crash to 3°C immediately after Diacetyl Rest / fermentation</span>
                    </label>
                    <label class="flex items-center gap-3 cursor-pointer">
                        <input type="checkbox" name="cold_crash_type" id="coldCrashGradual" value="gradual"
                            class="w-5 h-5 rounded accent-blue-400"
                            onchange="toggleColdCrash('gradual', this.checked)" />
...
function toggleColdCrash(type, checked) {
    if (checked) {
        // Uncheck the other one — mutually exclusive
        const other = type === 'direct' ? 'coldCrashGradual' : 'coldCrashDirect'
