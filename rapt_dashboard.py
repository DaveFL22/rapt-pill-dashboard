...
# ============================================================
#  BLOCK F3 — DASHBOARD ROUTES (INCLUDING TEMP OFFSET SUPPORT)
# ============================================================
...
#  (NOW FULLY COMPATIBLE WITH RAPT TEST WEBHOOK)
# ============================================================
...
def webhook():
    ...
    try:
        # RAPT Test Webhook sends text/plain, so we force JSON parsing
        try:
