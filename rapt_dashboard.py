...
<body class="bg-zinc-950 text-white min-h-screen p-6">
    ...
    <!-- HEADER -->
    <div class="max-w-5xl mx-auto flex flex-col gap-3 md:flex-row md:justify-between md:items-start mb-6">
        ...
        <div class="flex flex-col items-end gap-3 w-full md:w-auto">
            ...
            <!-- TOP RIGHT: Start New Brew -->
            <button onclick="openModal()"
                class="flex items-center justify-center bg-amber-400 hover:bg-amber-300 text-black font-semibold px-6 py-3 rounded-2xl w-full md:w-auto">
                + Start New Brew
            </button>
