...
<body class="bg-zinc-950 text-white min-h-screen p-6">
    ...
    <!-- VIEW LOG BUTTON (left-aligned, larger, more spacing) -->
    <div class="max-w-5xl mx-auto mt-12 mb-12">
        <div class="w-full flex justify-start">
            <a href="/view_log" target="_blank" rel="noopener"
               class="flex items-center justify-center gap-3 bg-zinc-800 hover:bg-zinc-700 
                      text-blue-400 text-lg px-8 py-6 rounded-2xl">
                📄 <span>View Log</span>
            </a>
        </div>
    </div>
