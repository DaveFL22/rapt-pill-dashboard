...
# ============================================================
#  BLOCK 5C — VIEW LOG PAGE + GET LOG ENDPOINT (MERGED + FIXED)
# ============================================================

@app.route("/view_log")
def view_log_page():
    """
    Renders the advanced Fermentation Log Viewer (Block 5B template)
    and loads the correct CSV filename for the current brew session.
    """
    # Determine correct CSV for this brew session
    csv_file = get_current_brew_log_csv_filename()
    ...
    # Render the viewer template (Block 5B)
...
def get_log():
    """
    Returns the CSV contents as JSON for the viewer.
    This fixes the 404 errors shown in your Render logs.
    """
    csv_file = get_current_brew_log_csv_filename()
