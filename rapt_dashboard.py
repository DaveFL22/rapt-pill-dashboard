...
# ============================================================
#  BASIC FERMENTATION LOGGING (NO GRAPH)
# ============================================================
def ensure_log_file():
...
def webhook():
    ...
    try:
        ...
        # Remove any session_start accidentally sent by the Pill
        data.pop("session_start", None)

        latest_data = data

        # BASIC LOGGING: SG + TEMP TO fermentation_log.json
        try:
